(function () {
     ...
     *                  <li>unit - {string=} - When set a unit value will be shown in the header in parenthesis. (Optional)</li>
     *              </ul>
     *          </li>
    ...
    /**
     * @ngdoc controller
     * @name components.dataList.controller:DataListController
     * @description
     *
    ...
    function DataListController($filter, $scope) {
        ...
        * @ngdoc function
        * @name filterChanged
        * @methodOf components.dataList.controller:DataListController
        *
        * @description
        *
        ...
        */
        function filterChanged(newFilter) {
            if (!!vm.config.onQuery) {
                vm.config.onQuery(newFilter, vm.orderField);
            }
            //Apply local filter
            filterList(newFilter, vm.orderField);
        }
        ...
        */
        function removeFilter() {
            ...
            vm.filter.value = '';
            filterList(vm.filter.value, vm.orderField);
        ...
        $scope.$watch(function () {
            return { data: vm.data, orderField: vm.orderField };
